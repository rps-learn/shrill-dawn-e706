...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/shrill-dawn-e706#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shrill-dawn-e706
```

A live public deployment of this template is available at [https://shrill-dawn-e706.templates.workers.dev](https://shrill-dawn-e706.templates.workers.dev)
